	...
	<div class="container">
		...
		<div class="row heading-bg">
			...
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">
					@isset($brand) ویرایش برند {{ $brand->title }} @else ثبت برند جدید @endisset
				</h5>
			</div>
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					<li class="active">
						<span>@isset($brand) ویرایش برند {{ $brand->title }} @else ثبت برند جدید @endisset</span>
					</li>
					<li>فروشگاه</li>
					<li>داشبورد</li>
				</ol>
							...
							<div class="form-wrap">
								<form action="@isset($brand) {{ route('brand.update', $brand->id) }} @else {{ route('brand.store') }} @endisset" method="POST">
									...
									<div class="row">
										...
										<div class="col-md-9">
											<div class="form-group">
												<label class="control-label mb-10" for="description">توضیح برند</label>
												<div class="input-group">
													<input type="text" name="description" id="description" @isset($brand) value="{{$brand->description}}" @else value="{{old('description')}}" @endisset class="form-control" placeholder="مثلا : برند کره ای سامسونگ" />
									...
									<div class="form-actions">
										<button class="btn @isset($brand) btn-warning @else btn-primary @endisset btn-icon right-icon mr-10 pull-left"> <i class="fa fa-check"></i>
											<span>@isset($brand) ویرایش @else ثبت @endisset برند</span>
										</button>
