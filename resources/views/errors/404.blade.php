		...
		<div class="wrapper  error-page pa-0">
			<header class="sp-header">
				...
				<div class="form-group mb-0 pull-right">
					<a class="inline-block btn btn-danger btn-rounded nonecase-font" href="/">بازگشت به صفحه اصلی</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<span class="block error-head text-center txt-danger mb-10">404</span>
											<span class="text-center nonecase-font mb-20 block error-comment">صفحه مورد نظر یافت نشد</span>
											<p class="text-center">متاسفانه صفحه ای که آدرس آن را وارد کرده اید در وبسایت یافت نشد :(</p>
										</div>	
									</div>	
								</div>
							</div>
